...
PATCH_DIR="$REPO_ROOT/firmware/patches/j722s-r1"
...
PATCHES=(
    ...
    "$PATCH_DIR/0002-main-r5-openhd.patch"
    "$PATCH_DIR/0003-c7x-ddr-identity-map.patch"
)

echo '===== J722S SPLIT-R1 SOURCE RECONSTRUCTION ====='
...
echo
echo "J722S_R1_PATCH_APPLY=PASS"
